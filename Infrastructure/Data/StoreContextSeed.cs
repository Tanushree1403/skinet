...
{
    //this class will seed in intial data from json files into the database
    public class StoreContextSeed
    {
        public static async Task SeedAsync(StoreContext context,ILoggerFactory loggerFactory){
            try{
                if(!context.ProductBrands.Any()){ //check if the db already has data or not in the ProductBrands table.
                      ...
                      await context.SaveChangesAsync(); // will push data into the database.
                }
